...
FileType('Historical Sulcal Openings Table', 'Text file')
FileType('Historical Cortical Thicknesses Table', 'Text file')
FileType('Historical Global Volumetry Table', 'Text file')
FileType('Historical Hippocampal Volumetry Table', 'Text file')
