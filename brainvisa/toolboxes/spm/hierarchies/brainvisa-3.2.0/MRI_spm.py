...
#using TPM
  ...
  '<subject>_forward_deformation_field', SetType('SPM deformation field'), SetWeakAttr('direction', 'forward'),
  '<subject>_inverse_deformation_field', SetType('SPM deformation field'), SetWeakAttr('direction', 'inverse'),
