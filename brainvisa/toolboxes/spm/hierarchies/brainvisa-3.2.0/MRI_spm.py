...
longitudinal_directory = (
    '<subject>_<followup>_halfway_to_<baseline>_bias_corrected',
        SetType('T1 MRI Bias corrected'),
        SetWeakAttr('transformation', 'none',
                    'warping_method', 'none',
                    'direction', 'followup_to_baseline'),
    '<subject>_<baseline>_halfway_to_<followup>_bias_corrected',
        SetType('T1 MRI Bias corrected'),
        SetWeakAttr('transformation', 'none',
                    'warping_method', 'none',
                    'direction', 'baseline_to_followup'),
    'iy_<subject>_<followup>_halfway_to_<baseline>_inverse_deformation_field',
        SetType('SPM deformation field'), 
        SetWeakAttr('direction', 'inverse',
                    'warping_method', 'low-dimensional',
                    'direction', 'followup_to_baseline'),
    'iy_<subject>_<baseline>_halfway_to_<followup>_inverse_deformation_field',
        SetType('SPM deformation field'), 
        SetWeakAttr('direction', 'inverse',
                    'warping_method', 'low-dimensional',
                    'direction', 'baseline_to_followup'),
    '<subject>_<followup>_halfway_to_<baseline>_white_proba',
        SetType( 'T1 MRI tissue probability map' ),
        SetWeakAttr('tissue_class', 'white',
                    'direction', 'followup_to_baseline',
                    'transformation', 'none',
                    'modulation', 'none',
                    'warping_method', 'none'),
    '<subject>_<baseline>_halfway_to_<followup>_white_proba',
        SetType( 'T1 MRI tissue probability map' ),
        SetWeakAttr('tissue_class', 'white',
                    'direction', 'baseline_to_followup',
                    'transformation', 'none',
                    'modulation', 'none',
                    'warping_method', 'none'),
    '<subject>_<followup>_halfway_to_<baseline>_grey_proba',
        SetType( 'T1 MRI tissue probability map' ),
        SetWeakAttr('tissue_class', 'grey',
                    'direction', 'followup_to_baseline',
                    'transformation', 'none',
                    'modulation', 'none',
                    'warping_method', 'none'),
    '<subject>_<baseline>_halfway_to_<followup>_grey_proba',
        SetType( 'T1 MRI tissue probability map' ),
        SetWeakAttr('tissue_class', 'grey',
                    'direction', 'baseline_to_followup',
                    'transformation', 'none',
                    'modulation', 'none',
                    'warping_method', 'none'),
    '<subject>_<followup>_halfway_to_<baseline>_csf_proba',
        SetType( 'T1 MRI tissue probability map' ),
        SetWeakAttr('tissue_class', 'csf',
                    'direction', 'followup_to_baseline',
                    'transformation', 'none',
                    'modulation', 'none',
                    'warping_method', 'none'),
    '<subject>_<baseline>_halfway_to_<followup>_csf_proba',
        SetType( 'T1 MRI tissue probability map' ),
        SetWeakAttr('tissue_class', 'csf',
                    'direction', 'baseline_to_followup',
                    'transformation', 'none',
...
insert( '{center}/{subject}/{analysis}', '{followup}_halfway_{baseline}', apply(SetContent, longitudinal_directory))
