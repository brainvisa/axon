...
def write_DARTEL_create_Templates_batch(self, spmJobFile, images_1_path, images_2_path, template_basename, reg_form, inner_iteration, reg_params, time_step, smooth_param, LM_reg, cycles, iterations):
    ...
    mat_file.write("""
        ...
        """ % ( images_1, images_2, template_basename, reg_form,
                inner_iteration[0], reg_params[
                    0], time_step[0], smooth_param[0],
                inner_iteration[1], reg_params[
                    1], time_step[1], smooth_param[1],
                inner_iteration[2], reg_params[
                    2], time_step[2], smooth_param[2],
                inner_iteration[3], reg_params[
                    3], time_step[3], smooth_param[3],
                inner_iteration[4], reg_params[
                    4], time_step[4], smooth_param[4],
                inner_iteration[5], reg_params[
                    5], time_step[5], smooth_param[5],
