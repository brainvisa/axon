...
#
def write_pairedTTest_matFile(context, pairsPathList, matfileDI, mat_file                                            
                                  , outDir, gmsca="""0""", ancova="""0"""
    ...
    writeGlobalNormalization_inMatfile(context, mat_file, gmsca_no, gmsca_yes_gmscv, glonorm)      
    mat_file.close()
...
def convertPathList(subjectsPathList):
  subjectsPathListForSPM = ["\n\t\t\t\t\t\t\t\t" + "'" + str(group1Path) + ",1'" for group1Path in subjectsPathList]
