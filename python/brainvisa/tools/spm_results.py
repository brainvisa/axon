...
#the following is use in nuclearimaging/processes/analyzes/alyDesignMatrix.py and alyDesignExploreFilesAndFactors.py
...
#the following is use in nuclearimaging/processes/analyzes/alyDesignExploreFilesAndFactors.py
def writeBatchAboutDesignExploreFileAndFactor(matlab_batch_path, 
  ...
  matlab_batch_file = addSPMRunScriptInBatch(matlab_batch_file, spm8_path, spm_batch_path)
