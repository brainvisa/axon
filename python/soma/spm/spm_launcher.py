...
class SPM(SPMLauncher):
    ...
    def _runMatlabScript(self, use_matlab_options, matlab_script_path):
        ...
        matlab_commmand = ['bv_unenv', self.matlab_executable_path, matlab_run_options, "-r \"run('%s');\" -nodisplay" %matlab_script_path]  # bv_unenv is needed for CentOs 7 (LIB & Pitie)
