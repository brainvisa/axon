# -*- coding: utf-8 -*-
from soma.spm.virtual_spm.tools.dartel_tools.normalise_to_mni.many_subjects import ManySubjects
from soma.spm.virtual_spm.tools.dartel_tools.normalise_to_mni.few_subjects_container import FewSubjectsContainer
